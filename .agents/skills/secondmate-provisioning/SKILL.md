...
Inherited `config/project-context-links` lets secondmate-routed nested or split repositories load the same authoritative external project context roots the primary uses.
