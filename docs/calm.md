...
Calm hides collapsed thinking labels, mid-turn assistant working notes, the transcript rows for Pi's built-in tool names, the `fm_watch_arm_pi` tool shell, and canonically classified Firstmate operational user rows.
