...
A nonempty `FM_TASK_ID` excludes an ordinary worker before any home checks, even when recovered `FM_ROOT_OVERRIDE` names the primary checkout or a marked secondmate home.
