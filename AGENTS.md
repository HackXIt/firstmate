...
config/project-context-links  optional project-name -> absolute authoritative-root pointers for projects whose authoritative context lives outside their dispatched repo; LOCAL, gitignored; inherited by secondmate homes under secondmate-provisioning
