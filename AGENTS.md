...
config/herdr-presentation-spaces  optional Herdr visual projection preference; LOCAL, gitignored; inherited by secondmate homes; docs/herdr-backend.md "Presentation spaces" owns topic-home exclusion, accepted values, and defaults
