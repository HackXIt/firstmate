...
# spawn on codex too, primary config/project-context-links points nested-repo
# work at the same authoritative external context roots, primary
...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness project-context-links backlog-backend backend herdr-presentation-spaces startup-memory-budget trace-context}"
